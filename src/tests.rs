...
test_instruction!(test_fmadd_d, 0x0220f043,Fmadd_d, "fmadd_d");
test_instruction!(test_fmsub_d, 0x0220f047,Fmsub_d, "fmsub_d");
test_instruction!(test_fnmsub_d, 0x0220f04b,Fnmsub_d, "fnmsub_d");
test_instruction!(test_fnmadd_d, 0x0220f04f,Fnmadd_d, "fnmadd_d");
test_instruction!(test_fadd_d, 0x0220f053,Fadd_d, "fadd_d");
test_instruction!(test_fsub_d, 0x0a20f053,Fsub_d, "fsub_d");
test_instruction!(test_fmul_d, 0x1220f053,Fmul_d, "fmul_d");
test_instruction!(test_fdiv_d, 0x1a20f053,Fdiv_d, "fdiv_d");
test_instruction!(test_fsqrt_d, 0x5a00f053,Fsqrt_d, "fsqrt_d");
test_instruction!(test_fsgnj_d, 0x22208053,Fsgnj_d, "fsgnj_d");
test_instruction!(test_fsgnjn_d, 0x22209053,Fsgnjn_d, "fsgnjn_d");
test_instruction!(test_fsgnjx_d, 0x2220a053,Fsgnjx_d, "fsgnjx_d");
test_instruction!(test_fmin_d, 0x2a208053,Fmin_d, "fmin_d");
test_instruction!(test_fmax_d, 0x2a209053,Fmax_d, "fmax_d");
test_instruction!(test_fcvt_s_d, 0x4010f053,Fcvt_s_d, "fcvt_s_d");
test_instruction!(test_fcvt_d_s, 0x4200f053,Fcvt_d_s, "fcvt_d_s");
test_instruction!(test_feq_d, 0xa220a2d3,Feq_d, "feq_d");
test_instruction!(test_flt_d, 0xa22092d3,Flt_d, "flt_d");
test_instruction!(test_fle_d, 0xa22082d3,Fle_d, "fle_d");
test_instruction!(test_fclass_d, 0xe20092d3,Fclass_d, "fclass_d");
test_instruction!(test_fcvt_w_d, 0xc200f2d3,Fcvt_w_d, "fcvt_w_d");
test_instruction!(test_fcvt_wu_d, 0xc210f2d3,Fcvt_wu_d, "fcvt_wu_d");
test_instruction!(test_fcvt_d_w, 0xd2037053,Fcvt_d_w, "fcvt_d_w");
test_instruction!(test_fcvt_d_wu, 0xd2137053,Fcvt_d_wu, "fcvt_d_wu");
test_instruction!(test_fcvt_l_d, 0xc220f2d3,Fcvt_l_d, "fcvt_l_d");
test_instruction!(test_fcvt_lu_d, 0xc230f2d3,Fcvt_lu_d, "fcvt_lu_d");
test_instruction!(test_fmv_x_d, 0xe20082d3,Fmv_x_d, "fmv_x_d");
test_instruction!(test_fcvt_d_l, 0xd2237053,Fcvt_d_l, "fcvt_d_l");
test_instruction!(test_fcvt_d_lu, 0xd2337053,Fcvt_d_lu, "fcvt_d_lu");
test_instruction!(test_fmv_d_x, 0xf2030053,Fmv_d_x, "fmv_d_x");
