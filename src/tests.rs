...
test_instruction!(test_fmadd_s, 0x90117043, FmaddS, "fmadds");
test_instruction!(test_fmsub_s, 0x90117047, FmsubS, "fmsubs");
test_instruction!(test_fnmsub_s, 0x9011704b, FnmsubS, "fnmsubs");
test_instruction!(test_fnmadd_s, 0x9011704f, FnmaddS, "fnmadds");
test_instruction!(test_fadd_s, 0x0020a1d3, FaddS, "fadds");
test_instruction!(test_fsub_s, 0x08747653, FsubS, "fsubs");
test_instruction!(test_fmul_s, 0x1025f453, FmulS, "fmuls");
test_instruction!(test_fdiv_s, 0x183170d3, FdivS, "fdivs");
test_instruction!(test_fsqrt_s, 0x5805f053, FsqrtS, "fsqrts");
test_instruction!(test_fsgnj_s, 0x20a58053, FsgnjS, "fsgnjs");
test_instruction!(test_fsgnjn_s, 0x20a59053, FsgnjnS, "fsgnjns");
test_instruction!(test_fsgnjx_s, 0x20a5a053, FsgnjxS, "fsgnjxs");
test_instruction!(test_fmin_s, 0x28228453, FminS, "fmins");
test_instruction!(test_fmax_s, 0x28229453, FmaxS, "fmaxs");
test_instruction!(test_fcvt_w_s, 0xc00081d3, FcvtWS, "fcvtws");
test_instruction!(test_fcvt_wu_s, 0xc01091d3, FcvtWuS, "fcvtwus");
test_instruction!(test_fmv_x_w, 0xe00081d3, FmvXW, "fmvxw");
test_instruction!(test_feq_s, 0xa020a1d3, FeqS, "feqs");
test_instruction!(test_flt_s, 0xa02091d3, FltS, "flts");
test_instruction!(test_fle_s, 0xa02081d3, FleS, "fles");
test_instruction!(test_fclass_s, 0xe00091d3, FclassS, "fclasss");
test_instruction!(test_fcvt_s_w, 0xd00081d3, FcvtSW, "fcvtsw");
test_instruction!(test_fcvt_s_wu, 0xd01091d3, FcvtSWu, "fcvtswu");
test_instruction!(test_fmv_w_x, 0xf00081d3, FmvWX, "fmvwx");

test_instruction!(test_fcvt_l_s, 0xc02081d3, FcvtLS, "fcvtls");
test_instruction!(test_fcvt_lu_s, 0xc03091d3, FcvtLuS, "fcvtlus");
test_instruction!(test_fcvt_s_l, 0xd02081d3, FcvtSL, "fcvtsl");
test_instruction!(test_fcvt_s_lu, 0xd03091d3, FcvtSLu, "fcvtslu");

test_instruction!(test_fld, 0x07b43007, Fld, "fld");
test_instruction!(test_fsd, 0x06043da7, Fsd, "fsd");
test_instruction!(test_fmadd_d, 0x0220f043, FmaddD, "fmaddd");
test_instruction!(test_fmsub_d, 0x0220f047, FmsubD, "fmsubd");
test_instruction!(test_fnmsub_d, 0x0220f04b, FnmsubD, "fnmsubd");
test_instruction!(test_fnmadd_d, 0x0220f04f, FnmaddD, "fnmaddd");
test_instruction!(test_fadd_d, 0x0220f053, FaddD, "faddd");
test_instruction!(test_fsub_d, 0x0a20f053, FsubD, "fsubd");
test_instruction!(test_fmul_d, 0x1220f053, FmulD, "fmuld");
test_instruction!(test_fdiv_d, 0x1a20f053, FdivD, "fdivd");
test_instruction!(test_fsqrt_d, 0x5a00f053, FsqrtD, "fsqrtd");
test_instruction!(test_fsgnj_d, 0x22208053, FsgnjD, "fsgnjd");
test_instruction!(test_fsgnjn_d, 0x22209053, FsgnjnD, "fsgnjnd");
test_instruction!(test_fsgnjx_d, 0x2220a053, FsgnjxD, "fsgnjxd");
test_instruction!(test_fmin_d, 0x2a208053, FminD, "fmind");
test_instruction!(test_fmax_d, 0x2a209053, FmaxD, "fmaxd");
test_instruction!(test_fcvt_s_d, 0x4010f053, FcvtSD, "fcvtsd");
test_instruction!(test_fcvt_d_s, 0x4200f053, FcvtDS, "fcvtds");
test_instruction!(test_feq_d, 0xa220a2d3, FeqD, "feqd");
test_instruction!(test_flt_d, 0xa22092d3, FltD, "fltd");
test_instruction!(test_fle_d, 0xa22082d3, FleD, "fled");
test_instruction!(test_fclass_d, 0xe20092d3, FclassD, "fclassd");
test_instruction!(test_fcvt_w_d, 0xc200f2d3, FcvtWD, "fcvtwd");
test_instruction!(test_fcvt_wu_d, 0xc210f2d3, FcvtWuD, "fcvtwud");
test_instruction!(test_fcvt_d_w, 0xd2037053, FcvtDW, "fcvtdw");
test_instruction!(test_fcvt_d_wu, 0xd2137053, FcvtDWu, "fcvtdwu");
test_instruction!(test_fcvt_l_d, 0xc220f2d3, FcvtLD, "fcvtld");
test_instruction!(test_fcvt_lu_d, 0xc230f2d3, FcvtLuD, "fcvtlud");
test_instruction!(test_fmv_x_d, 0xe20082d3, FmvXD, "fmvxd");
test_instruction!(test_fcvt_d_l, 0xd2237053, FcvtDL, "fcvtdl");
test_instruction!(test_fcvt_d_lu, 0xd2337053, FcvtDLu, "fcvtdlu");
test_instruction!(test_fmv_d_x, 0xf2030053, FmvDX, "fmvdx");
